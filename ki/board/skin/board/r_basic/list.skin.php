...
<div id="bo_list" style="width:<?php echo $width; ?>">
    ...
    <div class="tbl_head01 tbl_wrap">
        ...
        <tr>
            ...
            <th scope="col" class="td_date"><?php echo subject_sort_link('wr_datetime', $qstr2, 1) ?>작성일</a></th>
            <th scope="col" class="td_hit"><?php echo subject_sort_link('wr_hit', $qstr2, 1) ?>조회</a></th>
