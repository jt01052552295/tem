<div class="m_menu_wrap" id="amenu">
    ...
    <div class="m_menu_h">
        ...
        <ul id="hd_nb">
            <li class="hd_nb1"><a href="<?php echo G5_LANG_URL ?>/customer/sitemap.php" id="snb_qa"><i class="fas fa-sitemap" aria-hidden="true"></i><br><?php echo $infodu['lang']['common']['txt06']?></a></li>
            <li class="hd_nb2"><a href="<?php echo G5_LANG_URL ?>/mail/mail.php" id="snb_faq"><i class="fa fa-question-circle" aria-hidden="true"></i><br><?php echo $infodu['lang']['common']['txt05']?></a></li>
        </ul>
