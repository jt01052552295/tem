    ...
    <div class="header_wrap tran-animate" id="header_height">
        ...
        <div class="k_wrap menu_aid">
            <div class="k_container type_center">
                <div class="etc_menu">
                    ...
                    <a href="<?php echo G5_LANG_URL?>/customer/sitemap.php"><?php echo $infodu['lang']['common']['top02']?></a>
                </div><!-- etc_menu -->
        ...
        <div class="headerBox">           
            ...
            <div class="right">
                <ul> 
                    <?php if($is_member){?>
                    <li><a href="<?php echo G5_BBS_URL?>/member_confirm.php?url=register_form.php" class="on"><?php echo $infodu['lang']['common']['top03']?></a></li>
                    <li><a href="<?php echo G5_BBS_URL?>/logout.php" class="login"><?php echo $infodu['lang']['common']['top04']?></a></li>
                    <?php }else{?>

                    <li><a href="<?php echo G5_BBS_URL; ?>/register.php" class="on"><?php echo $infodu['lang']['common']['top05']?></a></li>
                    <li><a href="<?php echo G5_BBS_URL; ?>/login.php?url=<?php echo $urlencode; ?>" class="login"><?php echo $infodu['lang']['common']['top06']?></a></li>
                    <?php }?>
