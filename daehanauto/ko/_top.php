    ...
    <div class="header_wrap tran-animate" id="header_height">
        <div class="headerBox">
            ...
            <div class="etc_menu">
                ...
                <a href="<?php echo G5_URL?>/en" id="lang_btn">English</a> &nbsp;
                <?php if($is_member){?>
        ...
        <div class="subMenuBg">
            <div class="subMenuClose"><a href="#"><img alt="서비스메뉴닫기" src="<?php echo G5_LANG_IMG_URL?>/gnb_close.gif"></a></div>
        </div>
    </div> 
</header>
...
<div class="sub_vg"  style="display: none">
    <div id="vg_con">
        <p>You are the frontier in valve industry with the</p>
        <h2>HIFLY VALVE</h2>
    </div>
</div>
