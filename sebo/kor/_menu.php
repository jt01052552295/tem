...
$routeName = G5_LANG_URL."/contact";
$siteMenu[] = array(
	mCode 		=> "50",	
	title 		=> "Contact Us",		
	url 		=> $routeName."/contact.php",		  
	pid 		=> "contact",
	subTitle	=> "contact us",
	me_link		=> true,	
	me_use 		=> true
...
$siteMenu[] = array(
	mCode 		=> "60",	
	title 		=> "공지및뉴스",		
	url 		=> $routeName."/board.php?bo_table=notice&lang=kor",		  
	pid 		=> "notice1",	
	subTitle	=> "notice",
	me_link		=> false,	
	me_use 		=> true
...
$siteMenu[] = array(
	mCode 		=> "6020",	
	title 		=> "Vessels Value Weekly Change",		
	url 		=> $routeName."/board.php?bo_table=gall&lang=kor",		  
	pid 		=> "gall",			
	me_link		=> true,	
	me_use 		=> true
);
