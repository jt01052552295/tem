...
$siteMenu[] = array(mCode => "1010", title => "인사말", 	url => $routeName."/message.php", pid => "message", me_link => true, me_use => true );
...
$routeName = G5_LANG_URL."/sign";
$siteMenu[] = array(
	mCode 		=> "20",	
	title 		=> "간판",		
	url 		=> $routeName."/sign.php",		  
	pid 		=> "sign",	
	me_link		=> true,	
	me_use 		=> true
);
$routeName = G5_LANG_URL."/banner";
$siteMenu[] = array(
	mCode 		=> "30",	
	title 		=> "현수막",		
	url 		=> $routeName."/banner.php",		  
	pid 		=> "banner",	
	me_link		=> true,	
	me_use 		=> true
);

$routeName = G5_LANG_URL."/window";
$siteMenu[] = array(
	mCode 		=> "40",	
	title 		=> "윈도우사인",		
	url 		=> $routeName."/window.php",		  
	pid 		=> "window",	
	me_link		=> true,	
	me_use 		=> true
);

$routeName = G5_LANG_URL."/real";
$siteMenu[] = array(
	mCode 		=> "50",	
	title 		=> "실사 사인물",		
	url 		=> $routeName."/real.php",		  
	pid 		=> "real",	
	me_link		=> true,	
	me_use 		=> true
);

$routeName = G5_LANG_URL."/print";
$siteMenu[] = array(
	mCode 		=> "60",	
	title 		=> "인쇄물",		
	url 		=> $routeName."/print.php",		  
	pid 		=> "print",	
	me_link		=> true,	
	me_use 		=> true
);
