...
<!-- ++++++++++탑이미지++++++++++ -->
<div style="padding-left: 10px; position : relative; margin : 10px 0px; font-size: 18px; color: #BB911A;">
	<div style="position : absolute; width: 5px; height: 50px; background-color :#D11920; left:0px;"></div>
	궁금하신 사항이 있으신가요?<br/>
...
<tr>
	<!-- 이름 -->
	<td nowrap class="mail_kind"><span class="mail_star">*</span>고객명</td>
...
<tr>
	...
	<td colspan="3" class="mail_input"><textarea name="memo" style="width: 99%;" <?=$input_size_memo?>></textarea></td>
</tr>
