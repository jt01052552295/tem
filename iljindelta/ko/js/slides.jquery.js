	...
	$.fn.slides = function( option ) {
		...
		return this.each(function(){
			...
			if (option.generatePagination) {
				...
				$("#bodymain").append('<ul class='+ option.paginationClass +'></ul>');
				//elem.append('<ul class='+ option.paginationClass +'></ul>');
				// for each slide create a list item and link
				control.children().each(function(){
					$('.' + option.paginationClass).append('<li><a rel='+ number +' href="#"></a></li>');
					number++;
				});
			}
			// add current class to start slide pagination
			$('.' + option.paginationClass + ' li a:eq('+ start +')').parent().addClass('current');
			// click handling 
				...
				if (!active && loaded) {
					...
					switch(direction) {
						...
						case 'pagination':
							...
							prev = $('.' + option.paginationClass + ' li.current a').attr('rel');
					...
					if (option.pagination) {
						...
						$('.'+ option.paginationClass +' li.current').removeClass('current');
						// add current class to next
						$('.'+ option.paginationClass +' li a:eq('+ next +')').parent().addClass('current');
					}
				}
