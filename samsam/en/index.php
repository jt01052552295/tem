...
<div class="vg_inner">
    ...
    <div class="vg_title" id="title1">
        ...
        <p class="init-pc">We pursue environmental conservation<br />through resource recycling</p>

        <div class="vg_link init-pc">
            <a href="#" class="tran-animate"><span>ABOUT US</span></a>
        </div>
    </div>
    ...
    <section class="k_wrap" id="mainEffect3">
        <div class="k_container type_center">
            <div class="customerInner">
                <h2 class="title msg_effect">Products <small>We develop the company through environmental friendly management and create value for customer satisfaction</small></h2>
