<header id="header" class=" <?php echo (!defined("_INDEX_"))?'sub':'main';?>" >
...
<div class="sub_vg">
    <div id="vg_con">
        <p class=""><?php echo $infodu['lang']['sub']['common']['txt01']?></p>
        <h2 class=""><?php echo $infodu['lang']['sub']['common']['txt02']?><br/><?php echo $infodu['lang']['sub']['common']['txt03']?></h2>
    </div>
</div>
