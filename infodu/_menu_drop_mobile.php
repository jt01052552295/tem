        ...
        <ul class="m-nav">
            ...
            <li>
                <a  
                    ...
                    class="mName menu_link2 <?php echo $cls;?>" 
...
<script>
    $(document).ready(function(){
        ...
        $('.menu_link2').click(function(e){
            ...
            switch (_this){
                case 'service_mobile': $('html, body').animate({scrollTop : $_service_section}, 400, function(){  $('.m_menu_wrap').fadeOut(); }); break;
                case 'management_mobile': $('html, body').animate({scrollTop : $_work_section}, 400, function(){  $('.m_menu_wrap').fadeOut(); }); break;
                case 'portfolio_mobile': $('html, body').animate({scrollTop : $_portfolio_section}, 400, function(){  $('.m_menu_wrap').fadeOut(); }); break;
                case 'customer_mobile': $('html, body').animate({scrollTop : $_cs_section}, 400, function(){  $('.m_menu_wrap').fadeOut(); }); break;
                case 'message_mobile': $('html, body').animate({scrollTop : $_mail_section}, 400, function(){  $('.m_menu_wrap').fadeOut(); }); break;
            }
        }); 
