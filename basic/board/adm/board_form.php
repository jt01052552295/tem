...
if ($w == '') {
    ...
    $board['bo_gallery_width'] = 185;
    $board['bo_gallery_height'] = 140;
    ...
    $board['bo_reply_level'] = 10;
    $board['bo_comment_level'] = 10;
    $board['bo_link_level'] = 10;
    
    
    $board['bo_use_dhtml_editor'] = true;
    $board['bo_use_list_view'] = true;
