		...
		maxHeight = Math.max.apply(null, heights);
		 ...
		 $('#gnbnav').hover(
		 	function(){
				...
				$topNavSub.addClass('on');
				$topNavBg.show().stop().animate({height:maxHeight},_menuShowSpeed);
		 	}, function(){
				$topNavSub.removeClass('on');
				$topNavBg.hide().stop().animate({height:0},_menuShowSpeed);
		 	}
		 );
