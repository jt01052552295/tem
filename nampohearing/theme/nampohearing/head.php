...
<div id="hd">
        ...
        <div id="tnb">
        	<div class="inner">
    			<ul id="hd_qnb">
                    ...
                    <li ><a href="<?php echo G5_PAGE_URL ?>/sitemap.php"><?php echo $infodu['lang']['common']['top03']?></a></li>
                    <!-- <li><a href="#none" id="addFavorite"><?php echo $infodu['lang']['common']['top04']?></a></li> -->

                    <?php if ($is_member) {  ?>
                    <li><a href="<?php echo G5_BBS_URL ?>/member_confirm.php?url=<?php echo G5_BBS_URL ?>/register_form.php"><?php echo $infodu['lang']['common']['top07']?></a></li>
                    <li class="last"><a href="<?php echo G5_BBS_URL ?>/logout.php"><?php echo $infodu['lang']['common']['top08']?></a></li>
                    <?php } else {  ?>
                    <li class="last"><a href="<?php echo G5_BBS_URL ?>/login.php"><?php echo $infodu['lang']['common']['top05']?></a></li>
                    <?php }  ?>
    ...
    <?php if(defined('_INDEX_')) { ?>
        ...
        <div class="vg_inner">
            <ul class="main-slider">               
                <li class="main-slider-li" style="background-image: url(<?php echo G5_THEME_IMG_URL?>/vg01.jpg);">
                    <div class="vg_box">
                        <div class="vg_title">
                            <h2 class=""><?php echo $infodu['lang']['common']['vg01_sm']?></h2>
                            <p class=""><?php echo $infodu['lang']['common']['vg01_bg']?></p>
                        </div>
                    </div>
                </li>
                <li class="main-slider-li" style="background-image: url(<?php echo G5_THEME_IMG_URL?>/vg02.jpg);">
                    <div class="vg_box">
                        <div class="vg_title">
                            <h2 class=""><?php echo $infodu['lang']['common']['vg02_sm']?></h2>
                            <p class=""><?php echo $infodu['lang']['common']['vg02_bg']?></p>
                        </div>
                    </div>
                </li>
            </ul>
    ...
    <?php } else { ?>
        <div class="hd_box sub">
            <div class="sub_vg_title">
                <h2 class="t_shadow"><?php echo $breadcrumArr[0]['title'];?></h2>
                <p class="t_shadow"><?php echo $infodu['lang']['common']['vgSubTxt']?></p>
            </div>
        </div>
    <?php } ?>
...
<div id="wrapper">
    ...
    <div id="container" class="noSide <?php echo (!defined("_INDEX_"))?'sub':'main'; ?>">
        <?php if (!defined("_INDEX_")) { ?><h2 id="container_title" style="display: none"><span title="<?php echo get_text($g5['title']); ?>"><?php echo get_head_title($g5['title']); ?></span></h2><?php } ?>
