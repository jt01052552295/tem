    ...
    <div class="header_wrap tran-animate" id="header_height">
        ...
        <div class="k_wrap menu_aid">
            <div class="k_container type_center">
                ...
                <div class="etc_menu2">
                    <a href="#" class="on"><span>늘푸른사회복지재단</span></a>
                    <a href="#"><span>늘푸른노인전문요양원</span></a>
                    <a href="#"><span>늘푸른노인요양원</span></a>
                    <a href="#"><span>한울타리재가노인지원센터</span></a>
                    <a href="#"><span>늘푸른주야간보호센터</span></a>
                </div>



                <div class="etc_menu">
                    <a href="<?php echo G5_LANG_URL?>">홈</a>
                   ...
                   <!--  <a href="#" id="lang_btn">Language <i class="fas fa-caret-down"></i></a> &nbsp; -->
                    ...
                    <?php }?>
                     <a href="<?php echo G5_LANG_URL?>/customer/sitemap.php">사이트맵</a>
                </div><!-- etc_menu -->
        ...
        <div class="headerBox">
            ...
            <div class="right">
                <ul> 
                    <li><a href="<?php echo G5_LANG_URL?>/company/location.php" class="on">오시는길</a></li>
                    <li><a href="<?php echo G5_LANG_URL?>/mail/mail.php">상담문의</a></li>
                </ul>
            </div>
