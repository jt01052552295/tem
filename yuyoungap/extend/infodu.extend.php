...
$status_lang = array('ko','en','jp','cn', 'vn');
...
/* 기본설정 */
if(G5_LANG=='en'){
	$siteTitle = "Yuyoung Apparel CO.,LTD.";
	$siteKeyword = "";
	$siteLang = "en";
} else if(G5_LANG=='cn'){
	$siteTitle = "Yuyoung Apparel CO.,LTD.";
...
////////////////// 운영자 정보
$infodu['admin']['homepage']    = "yuyoungap.com"; /// 홈페이지주소를 입력해주세요
...
if($master) {
	...
	$infodu['admin']['company']     = "(주)유영어페럴"; //// 회사명을 입력해주세요
