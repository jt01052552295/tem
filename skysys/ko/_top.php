<header id="header" class="main tran-animate" >
    ...
    <div class="header_wrap " id="header_height">
        ...
        <div class="headerBox">           
            ...
            <div class="lang">
                <div class="lang_m">
                    <ul class="lang_sub font_montserrat" >
                        <li><a href="#" class="active"><?php echo  $infodu['lang']['common']['lang01']?></a></li>
        ...
        <!--모바일메뉴!-->
        <div id="m_menu">
            <a href="#"><i class="fa fa-bars fa-1x"></i></a>
        </div>
...
<div class="sub_vg" style="display: block">
    <div id="vg_con">
        <h2 class="">
            ...
            ?>
            <small>홈<?php echo $breadcrum_str;?></small>
