        ...
        <div class="k_wrap menu_aid">
            <div class="k_container type_center">
                <div class="etc_menu">
                    ...
                    <?php if($is_member){?>
                        <a href="<?php echo G5_BBS_URL?>/member_confirm.php?url=register_form.php" class="on"><?php echo $infodu['lang']['common']['top03']?></a>
                        <a href="<?php echo G5_BBS_URL?>/logout.php" class="login"><?php echo $infodu['lang']['common']['top04']?></a>
                    <?php }else{?>
                        <a href="<?php echo G5_BBS_URL; ?>/register.php" class="on"><?php echo $infodu['lang']['common']['top05']?></a>
                        <a href="<?php echo G5_BBS_URL; ?>/login.php?url=<?php echo $urlencode; ?>" class="login"><?php echo $infodu['lang']['common']['top06']?></a>
                    <?php }?>
                </div><!-- etc_menu -->
