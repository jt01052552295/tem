...
<footer id="footer" <?php if (!defined("_INDEX_")): ?> class="subFooter" <?php endif; ?> >
    <div class="copyright_wrap font_nanum">
        ...
        <div class="copy_menu">
            <ul class="ft_ul">                   
                ...
                <li><a href="<?php echo G5_LANG_URL?>/customer/sitemap.php"><?php echo  $infodu['lang']['common']['ft02'] ?></a></li>
                <li><a href="<?php echo G5_LANG_URL?>/mail/mail.php"><?php echo  $infodu['lang']['common']['ft03'] ?></a></li>
