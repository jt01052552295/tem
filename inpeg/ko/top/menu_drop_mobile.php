<div class="m_menu_wrap" id="amenu">
    ...
    <div class="m_menu_h">
        ...
        <ul class="m-nav">
            ...
            ?>
            <li>
                <a href="<?=KI_URL.$order_category[$i]?>/<?=$page_1_html[$order_category[$i]][0]?>.html" class="mName <?php echo ($i==1)?'on':'';?>"><?php echo $cate_name[$order_category[$i]]?> <i class="fas fa-angle-down"></i></a>
