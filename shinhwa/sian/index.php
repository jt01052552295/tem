...
$_i[1] = './img/main_01.jpg'; 
$_t[1] = '메인'; 

$_i[2] = './img/main_01_o.jpg'; 
$_t[2] = '드랍메뉴01'; 
...
<!-- 		<li><a href="../sian/mypage.php">6.마이페이지</a></li> -->
<!-- 		<li><a href="../sian/join.php">7.회원가입</a></li> -->
<!-- 		<li><a href="../sian/policy.php">8.추가페이지</a></li> -->
<!-- 	</ul> -->
<!-- <div> -->
...
<div style="position:absolute; top:100px; left:1450px; width:150px; margin-left:30px;  height:auto; line-height:20px; padding:10px; font-size:14px; text-align:center; background:#333; color:#fff; border-radius:10%;">
- 시안보기 -<br/>
<? for($i=1;$i<=count($_i);$i++) {?>
