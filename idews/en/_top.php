<header  id="header" class="main" >
    <div class="header_wrap tran-animate" id="header_height">
        <div class="headerBox">
            ...
            <div class="etc_menu">
                <a href="<?php echo G5_LANG_URL?>"><?php echo $infodu['lang']['common']['txt04']?></a> &nbsp;
                <a href="<?php echo G5_LANG_URL?>/mail/mail.php"><?php echo $infodu['lang']['common']['txt05']?></a> &nbsp;
                <a href="<?php echo G5_LANG_URL?>/customer/sitemap.php"><?php echo $infodu['lang']['common']['txt06']?></a> &nbsp;
                <!-- <a href="#" id="lang_btn">Language <i class="fas fa-caret-down"></i></a> &nbsp; -->
                <?php if($is_member){?>
                <a href="<?php echo G5_BBS_URL?>/member_confirm.php?url=register_form.php"><?php echo $infodu['lang']['common']['txt07']?></a> &nbsp;
                <a href="<?php echo G5_BBS_URL?>/logout.php"><?php echo $infodu['lang']['common']['txt08']?></a> &nbsp;
                <?php }else{?>
...
<div class="sub_vg">
    <div id="vg_con">
        <p><?php echo $infodu['lang']['common']['txt09']?></p>
