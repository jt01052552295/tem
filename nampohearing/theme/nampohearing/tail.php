...
<div id="ft">
    ...
    <div id="ft_wr">
        ...
        <a href="<?php echo G5_URL; ?>" id="ft_logo"><img src="<?php echo G5_THEME_IMG_URL; ?>/copy_logo.png" alt=""></a>
        <div class="ft_info">
            <?php echo $infodu['lang']['common']['copy01']?><br/><br/>
            <?php echo $infodu['lang']['common']['copy02']?>

            <a href="http://www.koreaind.com" target="_blank" class="copy_link">
                <?php echo $infodu['lang']['common']['copy03']?>
            </a>
        </div>  
