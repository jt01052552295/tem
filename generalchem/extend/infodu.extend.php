...
////////////////// 운영자 정보
$infodu['admin']['homepage']    = "generalchem.co.kr"; /// 홈페이지주소를 입력해주세요
...
if($master) {
	...
	$infodu['admin']['email']   	= "generalchem@generalchem.co.kr"; // natotrade@daum.net
	$infodu['admin']['name'] 		= "운영자";
	$infodu['admin']['company']     = "제너럴켐(주)"; //// 회사명을 입력해주세요
