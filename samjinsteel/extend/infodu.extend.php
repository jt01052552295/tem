...
/* 기본설정 */
$infodu = array();
$infodu['title'] = "삼진철강 주식회사";
$infodu['keywords'] = "";
$infodu['email'] = "";
$infodu['device'] = "pc";

////////////////// 운영자 정보
$infodu['admin']['homepage']    = "samjinsteel.com"; /// 홈페이지주소를 입력해주세요
...
if($master) {
	...
	$infodu['admin']['email']   	= "korea@koreaind.com"; // samjinsteel33@daum.net
	$infodu['admin']['name'] 		= "운영자";
	$infodu['admin']['company']     = "Samjin steel co.,ltd."; //// 회사명을 입력해주세요
