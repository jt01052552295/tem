...
$routeName = G5_LANG_URL."/develop";
$siteMenu[] = array(
	mCode 		=> "40",	
	title 		=> "연구개발",		
	url 		=> $routeName."/develop.php",		  
	pid 		=> "",			
	subTitle	=> "연구개발",
	me_link		=> false,	
	me_use 		=> true
