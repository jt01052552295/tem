...
<head>
	...
	<link rel="stylesheet" href="<?=KI_URL?>css/reset.css?ver=<?php echo KI_TIME_YMD?>">
	<link rel="stylesheet" href="<?=KI_URL?>css/infodu.css?ver=<?php echo KI_TIME_YMD?>">
	<link rel="stylesheet" href="<?=KI_URL?>css/base.css?ver=<?php echo KI_TIME_YMD?>">
	<link rel="stylesheet" href="<?=KI_URL?>css/contents.css?ver=<?php echo KI_TIME_YMD?>">
	<link rel="stylesheet" href="<?=KI_URL?>mail/mailcss.css?ver=<?php echo KI_TIME_YMD?>">
