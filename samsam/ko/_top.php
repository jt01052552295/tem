    ...
    <div class="k_wrap header_wrap topPosition tran-animate" id="header_height">
        ...
        <div class="menu_aid">
            <div class="k_container14 type_center">
                <ul class="etc_menu">                   
                    ...
                    <?php }?>
                    <li><a href="<?php echo G5_URL?>/en" class="us">English</a></li>
                </ul>
            </div>
        </div>
        ...
        <div class="k_container14 type_center">
           ...
           <!--  <div class="lang">
            ...
            <div class="shop">
                <ul>
                    <li class="slideShop"><a href="#" class="cp tran-animate">삼삼기업<span class="sub_drop bg tran-animate"></span></a>
                        <ul class="shop2nd">
                            <li class=""><a href="http://www.samsam.co.kr/" target="_blank">삼삼종합건설(주)</a></li>
                            <li class=""><a href="http://www.samsam.co.kr/" target="_blank">삼삼환경(주)</a></li>
                            <li class=""><a href="http://www.samsamcc.co.kr/" target="_blank">삼삼컨트리클럽</a></li>
                            <li class=""><a href="http://www.honwon.co.kr">삼삼무역(주)</a></li>
                        </ul>
                    </li>
                </ul>
            </div> 
