...
<footer id="footer" <?php if (!defined("_INDEX_")): ?> class="subFooter" <?php endif; ?> >
    <div class="copyright_wrap">
        ...
        <div class="copy_addr">
             <p class="pc"><?php echo  $infodu['lang']['common']['txt01']?><br/><?php echo  $infodu['lang']['common']['txt02']?></p>
             <p class="mobile"><?php echo  $infodu['lang']['common']['txt01m']?><br/><?php echo  $infodu['lang']['common']['txt02']?></p>
