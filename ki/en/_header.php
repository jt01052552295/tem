...
<link rel="stylesheet" href="<?php echo KI_CSS_URL?>/contents.css?ver=<?php echo G5_CSS_VER; ?>">
<script src="<?php echo KI_JS_URL?>/jquery-1.8.3.min.js" ></script>
<script src="<?php echo KI_JS_URL?>/front.js?ver=<?php echo G5_JS_VER; ?>" ></script>
<script src='<?php echo KI_JS_URL?>/flash.js?ver=<?php echo G5_JS_VER; ?>'></script>
<script src="<?php echo KI_JS_URL?>/openwindow.js?ver=<?php echo G5_JS_VER; ?>"></script>
</head>
<body>
