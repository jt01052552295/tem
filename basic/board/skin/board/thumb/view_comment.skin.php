    ...
    <article id="c_<?php echo $comment_id ?>" <?php if ($cmt_depth) { ?>style="margin-left:<?php echo $cmt_depth ?>px;border-top-color:#e0e0e0"<?php } ?>>
        <header>
            ...
            <?
            	...
            	$wr_item =sql_fetch_array(sql_query("select mb_1, mb_2 from g5_member where mb_id = '$writer_id' limit 0, 1 "));
            	if($wr_item[mb_1] != "" && substr($wr_item[mb_1],0,5) != "https"){
            		$member_photo_array = explode(".", $wr_item[mb_1]);
            		$member_photo_extension = $member_photo_array[sizeof($member_photo_array)-1];
            		$wr_item[mb_thumb] = G5_DATA_URL.'/mb_img/'.$member_photo_array[0]."_thum.".$member_photo_extension;
					?> 
				<img alt="MEMBER" src="<?=$wr_item[mb_thumb]?>" class="comment_list_img">
				<?}else if($wr_item[mb_2] != ""){
					$wr_item[mb_thumb] = $wr_item[mb_2];?>
				<img alt="MEMBER" src="<?=$wr_item[mb_thumb]?>" class="comment_list_img">	
				<?}else{?>
				<img alt="MEMBER" src="<?=$wr_item[mb_thumb]?>" class="comment_list_img">
			<?}?>
