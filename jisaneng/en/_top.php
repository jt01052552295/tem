<header class="main" >
    ...
    <div class="k_wrap menu_aid">
        <div class="k_container1000 type_center">
            ...
            <div class="etc_menu2">
                <a href="#"><span class="ic_etc01"></span></a>
                <a href="#"><span class="ic_etc02"></span></a>
                <a href="#"><span class="ic_etc03"></span></a>
            </div>



            <div class="etc_menu">
                <a href="<?php echo G5_LANG_URL?>/mail/mail.php">INQUIRY</a> &nbsp;
                <a href="#">SITE MAP</a> &nbsp;
    ...
    <div class="contents_wrap <?php echo $sidebarCls?>">
        <div class="title_wrap">    
            <div class="sub_vg_title" style="display: block">
                ...
                <h2 class="title"><?php //echo $g5['title']; ?>
                    <?php 
