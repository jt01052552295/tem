...
/* 기본설정 */
$infodu = array();
$infodu['title'] = "(주)대한환경이엔지";
$infodu['keywords'] = "";
$infodu['email'] = "";
$infodu['device'] = "pc";

////////////////// 운영자 정보
$infodu['admin']['homepage']    = "daehan2ng.com"; /// 홈페이지주소를 입력해주세요
...
if($master) {
	...
	$infodu['admin']['email']   	= "daehan2ng@daum.net"; // natotrade@daum.net
	$infodu['admin']['name'] 		= "운영자";
	$infodu['admin']['company']     = "대한환경이엔지"; //// 회사명을 입력해주세요
