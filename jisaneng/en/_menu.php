...
$routeName = G5_LANG_URL."/more";
$siteMenu[] = array(
	mCode 		=> "30",	
	title 		=> "WHAT IS MORE",		
	url 		=> $routeName."/more.php",		  
	pid 		=> "",	
	subTitle	=> "more",
	me_link		=> false,	
	me_use 		=> true
...
$routeName = G5_LANG_URL."/did";
$siteMenu[] = array(
	mCode 		=> "40",	
	title 		=> "WHAT WE DID",		
	url 		=> $routeName."/did.php",		  
	pid 		=> "did",	
