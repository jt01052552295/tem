...
$(document).unbind("click").on('click','#btnRegistDefault',function(){
...
$(document).on('blur','#strId',function(){
	...
	try{
		var jqxhr = $.get('/proc/member_proc.php', {strType:'overlap',strId:$('#strId').val()}, function(d,e){
			var res = d.split('|');
			if(res[0] == "ok"){
				randNumber = res[1];
