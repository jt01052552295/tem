...
$status_lang = array('ru','ko','en','jp','cn');
...
/* 기본설정 */
$infodu = array();
$infodu['title'] = "Акционерное Общество Дехан Хвангён И Эн Джи";
$infodu['keywords'] = "";
$infodu['email'] = "";
$infodu['device'] = "pc";

////////////////// 운영자 정보
$infodu['admin']['homepage']    = "aaa.com"; /// 홈페이지주소를 입력해주세요
...
if($master) {
	...
	$infodu['admin']['company']     = "대한환경 이엔지"; //// 회사명을 입력해주세요
