...
<section class="k_wrap">
    <div class="vg_inner">
        ...
        <ul class="main-slider">
            <li class="main-slider-li" id="main-slider-0" style="background-image: url(<?php echo KI_IMG_URL?>/vg01.png);"></li>
            <li class="main-slider-li" id="main-slider-1" style="background-image: url(<?php echo KI_IMG_URL?>/vg02.png);"></li>
            <li class="main-slider-li" id="main-slider-3" style="background-image: url(<?php echo KI_IMG_URL?>/vg03.png);"></li>
        </ul>

        

        <div class="vg_down">
            <a href="#" id="go_service"><img src="<?php echo KI_IMG_URL?>/tt.png" alt="" /></a>
...
<link href="<?php echo KI_JS_URL?>/bxslider/dist/jquery.bxslider.carousel.css?ver=<?php echo KI_TIME_YMD?>" rel="stylesheet">
            ...
            <div class="partner_inner">
                ...
                <div class="partner-slider">
                    <div class="partner-box">
                        <a href="javascript:;">
                            <img src="<?=KI_IMG_URL?>/product01.png"  alt="" />
                            <div class="con">
                                <h4>PLUG</h4>
                                <p>차체홀부 기밀</p>
                            </div>
                    ...
                    <div class="partner-box">
                        <a href="javascript:;">
                            <img src="<?=KI_IMG_URL?>/product02.png"  alt="" />
                            <div class="con">
                                <h4>샤크 안테나 PAD</h4>
                                <p>사크안테나 누수방지 </p>
                            </div>
                    ...
                    <div class="partner-box">
                        <a href="javascript:;">
                            <img src="<?=KI_IMG_URL?>/product03.png"  alt="" />
                            <div class="con">
                                <h4>SPRING PAD</h4>
                                <p>압쇼바 충격 흡수, 소음방지</p>
                            </div>
