<header class="main" >
    ...
    <div class="k_wrap menu_aid">
        <div class="k_container1000 type_center">
            ...
            <div class="etc_menu2">
                <a href="#"><span class="ic_etc01">가고싶은섬</span></a>
                <a href="#"><span class="ic_etc02">통영날씨</span></a>
                <a href="#"><span class="ic_etc03">민박넷</span></a>
            </div>



            <div class="etc_menu">
                <a href="<?php echo G5_LANG_URL?>/mail/mail.php">고객센터</a> &nbsp;
                <a href="#">사이트맵</a> &nbsp;
                <a href="<?php echo G5_LANG_URL?>/company/location.php">오시는길</a> &nbsp;
...
<div class="k_wrap" id="subPageWrap">
    ...
    <div class="contents_wrap <?php echo $sidebarCls?>">
