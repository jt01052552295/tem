...
<div class="products">
    ...
    <div class="pro_view">
        ...
        <p>
            ...
            <?php echo ($_arr_product['diecasting'][$i]['c7'])?'<span>'.$_arr_product['diecasting'][$i]['k7'].' :</span> '.$_arr_product['diecasting'][$i]['c7'].'<br>':''?>
            <?php echo ($_arr_product['diecasting'][$i]['c8'])?'<span>'.$_arr_product['diecasting'][$i]['k8'].' :</span> '.$_arr_product['diecasting'][$i]['c8'].'':''?>
        </p>
         </div>
    </div>
    <?php endfor;?>
